  ...
  return (
    <div className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-6 bg-black text-white p-4 font-mono">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-6xl font-bold tracking-tighter text-white">GENIE</h1>
      ...
      <div className="mt-12 w-full max-w-4xl">
        <h2 className="text-sm text-gray-500 mb-4 uppercase tracking-widest">Community Worlds</h2>
        <div className="grid grid-cols-3 gap-4 opacity-50">
           {/* Placeholders */}
           {[1, 2, 3].map((i) => (
             <div key={i} className="aspect-video bg-gray-900 border border-gray-800 flex items-center justify-center text-xs text-gray-700">
               WORLD_DATA_0{i}
             </div>
           ))}
        </div>
